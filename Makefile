...
#deploy-sepolia:
#	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account sepolia-test --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
...
ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --account sepolia-test --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
endif
